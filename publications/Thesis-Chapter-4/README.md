# Optimising deep learning models for prediction of dry matter content in mango fruit with an extensive multi-population, multi-instrument spectral dataset
